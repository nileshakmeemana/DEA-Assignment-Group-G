...
<body class="bg-gray-50">
    ...
    <div class="relative bg-white overflow-hidden">
        <div class="flex flex-col lg:flex-row">
            <!-- Left Content -->
            <div class="w-full lg:w-1/2 py-12 lg:py-16 px-6 sm:px-12 lg:px-16">
                <div class="lg:text-left">
                    <h1 class="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block">Welcome to</span>
                        <span class="block text-indigo-600">Student Management System</span>
                    </h1>
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        A central platform for efficient management of student data, courses, grades, and attendance, optimizing administrative workflows.                    </p>
            ...
            <div class="w-full lg:w-1/2">
                <img class="w-full h-64 sm:h-72 md:h-96 lg:h-full object-cover" 
            ...
            <div class="mt-10">
                <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Easily manage courses, assignments, and course materials. Track student progress and performance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Grade Tracking</h3>
                            <p class="mt-2 text-base text-gray-500">
                                Record and monitor student grades, generate reports, and analyze academic performance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Attendance Management</h3>
                            <p class="mt-2 text-base text-gray-500">
                                Track student attendance, generate attendance reports, and identify attendance patterns.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <p class="mt-2 text-base text-gray-500">
                                Generate comprehensive reports and gain insights into student performance and institutional metrics.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-indigo-50">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                ...
                <span class="block text-indigo-600">Create your account today.</span>
            </h2>
            <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                ...
                <div class="ml-3 inline-flex rounded-md shadow">
                    <a href="login" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50">
                        Sign in
                    </a>
                </div>
            </div>
